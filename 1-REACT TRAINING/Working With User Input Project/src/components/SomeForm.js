...
const SomeForm = (props) => {
  const {
    ...
    inputChangeHandler: firstNameInputChangeHandler, // inputChangeHandler: inputChangeHandler,
  ...
  const {
    ...
    inputChangeHandler: lastNameInputChangeHandler, // inputChangeHandler: inputChangeHandler,
  ...
  const {
    ...
    inputChangeHandler: emailInputChangeHandler, // inputChangeHandler: inputChangeHandler,
